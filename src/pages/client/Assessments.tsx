...
import { Brain, AlertTriangle, Calendar, CheckCircle, Play, Eye } from 'lucide-react'
        ...
        <div className="xl:col-span-7 min-h-0">
          <div className="bg-white rounded-xl border border-gray-200 h-full flex flex-col">
            <div className="p-4 border-b border-gray-200 flex items-center justify-between">
              ...
              {active && (
                <button onClick={close} className="px-3 py-1.5 rounded border text-sm hover:bg-gray-50">Close</button>
              )}
            </div>
            <div className="min-h-0 overflow-y-auto p-4">
              {!active ? (
                ...
                <AssessmentForm
                  ...
                  showNavigation
                  showProgress
                  onResponse={() => {/* per-item upsert is inside AssessmentForm */}}
                  onSave={() => load()}
                  onComplete={async () => {
                    await load()
