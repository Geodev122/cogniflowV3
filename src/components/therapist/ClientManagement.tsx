...
<th className="w-32 px-3 py-2 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">
  Assessments
</th>
<th className="w-36 px-3 py-2 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">
  Last Session
</th>
<th className="w-40 px-3 py-2 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">
  Next Appointment
</th>
<th className="w-28 px-3 py-2 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">
  Actions
